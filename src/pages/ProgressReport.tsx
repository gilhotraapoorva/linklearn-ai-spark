...
const ProgressReport = () => {
  ...
  const stats = overviewStatsMap[timeframe];
      ...
      <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 pt-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center mb-6">
            ...
            <div className="ml-4">
              <h1 className="text-3xl font-extrabold text-blue-900">Progress Report</h1>
              <p className="text-blue-600 text-sm">Track your learning journey and achievements</p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex gap-2">
              {(['week', 'month', 'quarter'] as const).map((timeframe) => (
                <Button
                  key={timeframe}
                  variant={timeframe === timeframe ? 'default' : 'outline'}
                  size="sm"
                  onClick={() => setTimeframe(timeframe)}
                  className={timeframe === timeframe ? 'bg-blue-600 text-white' : 'border-blue-200 text-blue-700 hover:bg-blue-50 hover:text-blue-900'}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-white border-blue-100 shadow-sm">
              ...
              <CardContent className="space-y-6">
                {skillsProgressMap[timeframe].map((skill) => (
            ...
            <Card className="bg-white border-blue-100 shadow-sm">
              ...
              <CardContent className="space-y-4">
                {recentAchievementsMap[timeframe].map((achievement) => (
          ...
          <Card className="bg-white border-blue-100 shadow-sm mt-8">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-blue-900">
                ...
                {activityLabels[timeframe].heading}
              </CardTitle>
            </CardHeader>
            <CardContent>
