...
const redeemOptions = [
	...
	},
	{
		...
		description: "Access any course of your choice on LinkedIn Learning platform.",
		xp: 1000,
		icon: (
			<div className="min-w-[96px] h-16 flex items-center justify-center">
				<img
...
const RedeemXP = () => {
	...
	return (
		<>
			<Header />
			<div className="min-h-screen w-full flex flex-col items-center py-12 px-2 bg-gradient-to-br from-yellow-50 via-blue-50 to-white relative overflow-x-hidden pt-20">
				<DecorativeBg />
